...
%             uimenu(frh,'Label','Value...', 'Callback','disp(''value'')');
            ...
            obj.ForceInitButton.Position = [.205 .155 .2 .2]; %[left bottom width height]
            ...
            obj.FirmwareLoadButton.Position = [.005 .155 .2 .2]; %[left bottom width height]
            ...
            obj.FirmwarePathLabel.Position = [.005 .105 .2 .05]; %[left bottom width height]
            ...
            obj.Slider.Min = 0;
            obj.Slider.Max = 10;
            obj.Slider.Position = [.455 .20 .4 .05]; %[left bottom width height]
            ...
            obj.SliderValue.Position = [.455 .255 .4 .05]; %[left bottom width height]
...
%             handles = [h_sldr h_val];
            ...
            obj.DelayLabel.Position = [.1 .4 .35 .2]; %[left bottom width height]
            ...
            obj.DelayEdit.Position = [.4 .4 .2 .2]; %[left bottom width height]
            ...
            obj.WriteDelayButton.Position = [.7 .3 .2 .4]; %[left bottom width height]
            
            tab_fir0 = uitab('Parent', tgroup, 'Title', 'FIR-0');
            tab_fir1 = uitab('Parent', tgroup, 'Title', 'FIR-1');

            obj.Panel = uipanel('Parent',obj.Figure,'FontSize',14,'Position',[0.005 .005 0.995 .1]);
...
% --------------------------------------------------------------
            ...
            obj.ChassisField.Position = [0 0 0.2 0.5]; %[left bottom width height]
            obj.ChassisString.Position = [0.2 0 0.1 0.5]; %[left bottom width height]
            obj.SlotField.Position = [0.3 0 0.15 0.5]; %[left bottom width height]
            obj.SlotString.Position = [0.45 0 0.10 0.5]; %[left bottom width height]
            obj.SerialNumField.Position = [0.55 0 0.2 0.5]; %[left bottom width height]
            obj.SerialNumString.Position = [0.75 0 0.20 0.5]; %[left bottom width height]
end
